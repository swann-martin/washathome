      ...
      <div className="booking-details">
        ...
        <div className="booking-details-container">
          ...
          <div className="booking-details-container-right">
            {(booking.washer.pseudo !== userPseudo) &&
              <p className="booking-details-container-right-item"> Washer: {booking ? <span className="booking-details-container-right-item-element booking-details-container-right-item-element--pseudo">{booking.washer.pseudo}</span> : <span className="booking-details-container-right-item-element">pseudo du bringer</span>}</p>
            }
